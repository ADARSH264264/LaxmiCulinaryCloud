...
//   // DISPATCHERS WRAPPED WITH useCallback FOR PERFORMANCE
...
// INITIALIZE CART AS EMPTY (NO LOCALSTORAGE LOAD)
const initializer = () => {
  return []; // Har refresh pe empty cart
};
