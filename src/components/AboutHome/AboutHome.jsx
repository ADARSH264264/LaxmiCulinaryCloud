...
/* <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#111] to-[#000]
  text-white py-10 sm:py-20 relative overflow-hidden">
...
<div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col-reverse lg:flex-row items-center lg:gap-8 xl:gap-16 relative">
  ...
  <div className="w-full order-1 lg:order-2 space-y-8 sm:space-y-12 relative">
    ...
    <p className="text-base sm:text-lg md:text-xl opacity-90 leading-relaxed max-w-3xl font-serif italic px-4 sm:px-6 py-3 rounded-lg bg-gradient-to-r from-amber-400/30 via-amber-500/40 to-amber-600/30">
...
<div className='flex flex-wrap gap-4 items-center mt-6 sm:mt-8 px-4 sm:px-0'>
  ...
  >
    ...
    <span className='font-cursive text-lg sm:text-xl'>Unveil Our</span>
  </Link>

</div>


<div className='w-full order-2 lg:order-1 md:max-w-md lg:max-w-none lg:w-7/12 mt-12 mb-10 lg:mb-8 relative
group transform hover:scale-[1.01] transition-all duration-500'>

  <div className='relative rounded-[4rem] overflow-hidden border-4 border-amber-900/30 hover:border-amber-500/50
 ...
 <div className='w-full order-2 lg:order-1 lg:w-5/12 mt-10 lg:mt-0 relative group 
transform hover:scale-[1.01] transition-all duration-500'>

  <div className='relative rounded-[3rem] overflow-hidden border-4 border-amber-900/30 
  hover:border-amber-500/50 duration-500 shadow-2xl shadow-black/50'>
    ...
    <img
      src={AboutImage}
      alt="Restaurant"
      className='w-full h-auto max-h-[620px] object-contain transform -rotate-1 hover:rotate-0 transition-all duration-500 bg-black/10'
    />

    <div className='absolute -bottom-10 left-1/2 -translate-x-1/2 w-3/4 h-12 bg-amber-900/30 blur-3xl z-0'></div>
  </div>
  ...
  <FloatingParticle />
    ...
    <div className="w-full lg:w-1/2 order-1 lg:order-2 space-y-8 sm:space-y-12 relative">
      ...
      <div className="flex flex-wrap justify-center sm:justify-start gap-4 items-center mt-6 sm:mt-8 px-4 sm:px-0">
  <Link
    to="/about"
    className="px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-amber-500 to-orange-600
    rounded-xl font-bold hover:scale-[1.02] transition-transform duration-300 flex items-center gap-2 sm:gap-3
