    ...
    <div className='min-h-screen bg-gradient-to-r from-orange-900 via-amber-900 to-gray-900 animate-gradient-x py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 font-[Poppins] relative overflow-hidden'>
      ...
      <div className='max-w-7xl mx-auto relative z-10'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
          ...
          <div className='relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl animate-slide-in-right border border-amber-500/30 hover:border-amber-500/50 transform transition-border duration-300'>
                ...
                <div key={name}>
                  ...
                  <div className='relative'>
                    ...
                    <input
                      ...
                      className='w-full pl-10 pr-4 py-3 bg-white/10 border-2 border-amber-500/30 rounded-md text-amber-50 focus:ring-2 focus:ring-amber-500 focus:border-transparent placeholder-amber-200/50'
