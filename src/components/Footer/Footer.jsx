...
className='w-full px-4 py-2.5 rounded-lg bg-amber-50/5 border-2
border-amber-400/30 focus:border-amber-400 focus:ring-4 focus:ring-amber-400/20 
...
bg-gradient-to-br from-amber-300
via-orange-500 to-amber-600 text-white px-4 py-2 rounded-full
flex items-center gap-1.5 shadow-lg hover:shadow-amber-400/30 overflow-hidden transition'
>
<span 
...
<BiChevronRight 
  className="text-xl transition-transform duration-300 group-hover:animate-spin flex-shrink-0" 
/>
...
<div className="flex justify-center space-x-4">
  ...
  <p className="text-amber-400 text-lg mb-2 font-playfair">
    &copy; 2025 LAXMI-KITCHEN. All rights reserved.
  </p>

  <div className="group inline-block">
    <a
      href="https://webcos.in/"
      target="_blank"
      className="text-lg font-sacramento bg-gradient-to-r
      from-amber-400 via-amber-500 to-amber-400 bg-clip-text text-transparent
      hover:text-purple-300 transition-all duration-500"
    >
      Designed & Developed by <span className="font-semibold">Adarsh Kumar Gaud</span> @ Webcos
    </a>
  </div>
</div>
